...
allowed-tools:
  - Bash(npx impeccable *)
modifications:
  - 2026-04-17 (SuperClaude++): Command list references updated (`/audit` → `/design-audit`) due to rename.
---
...
- **Suggested command**: Which command could address this (from: /animate, /quieter, /shape, /optimize, /adapt, /clarify, /layout, /distill, /delight, /design-audit, /harden, /polish, /bolder, /typeset, /critique, /colorize, /overdrive)
...
- Only recommend commands from: /animate, /quieter, /shape, /optimize, /adapt, /clarify, /layout, /distill, /delight, /design-audit, /harden, /polish, /bolder, /typeset, /critique, /colorize, /overdrive
