...
| Query parameters | camelCase | `?startDate=2025-01` |
...
| Virtual env | Managed by uv automatically |
...
| Pages (Next.js) | kebab-case directories | `app/user-profile/page.tsx` |
...
| Test descriptions (describe) | Target component/function | `describe('UserCard', ...)` |
| Test cases (it/test) | should + behavior | `it('should render user name', ...)` |
| Test directories | __tests__ or tests | `src/__tests__/`, `tests/` |
